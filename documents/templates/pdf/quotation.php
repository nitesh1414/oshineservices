<?php
/**
 * Quotation PDF template (letter style, same visual language as the invoice).
...
$metaRows = [
    ...
    ['Valid Until', format_date($doc->valid_until)],
];
if ((string) $org['vendor_code'] !== '') {
    $metaRows[] = ['BPCL Vendor Code', (string) $org['vendor_code']];
}
?>
<!DOCTYPE html>
<html lang="en">
...
<table class="title-row">
    <tr>
        ...
        <td class="doc-copy" style="width:20%"></td>
    </tr>
</table>
...
<table class="block joined party">
                ...
                <tr class="party-body">
                    <td class="left">
                        ...
                        <div><?= $c['address'] !== '' ? nl2br_e($c['address']) : '' ?></div>
                    </td>
                    <td>
                        <table class="kv">
                            <tr><td class="k">GSTIN</td><td><?= $c['gstin'] !== '' ? '<strong>' . e($c['gstin']) . '</strong>' : '&mdash;' ?></td></tr>
                            <tr><td class="k">Place of Supply</td><td><?= $c['place_of_supply'] !== '' ? e($c['place_of_supply']) . ($c['state_code'] !== '' ? ' (' . e($c['state_code']) . ')' : '') : '&mdash;' ?></td></tr>
                            <tr><td class="k">Your Reference</td><td><?= $doc->reference !== '' ? e($doc->reference) : '&mdash;' ?></td></tr>
                        </table>
                    </td>
                </tr>
            </table>

            <div class="subject"><strong>Subject:</strong> <?= e($doc->subject) ?></div>

            <div class="intro">
                Respected Sir/Madam, with reference to the above subject we are pleased to submit our quotation for the work as detailed below:
            </div>
                ...
                <tr>
                    <td class="bank">
                        ...
                        <table class="bank-table">
                            ...
                            <tr><td class="k">Bank Name</td><td><?= e($org['bank']['bank_name']) ?> &mdash; <?= e($org['bank']['branch']) ?></td></tr>
...
<div class="avoid-break">
            <table class="block foot">
                <tr>
                    <td class="terms">
                        ...
                        <?php endif; ?>
                        <div style="margin-top:5pt; font-size:7.6pt; line-height:1.05;">
                            We trust you will find our offer competitive and look forward to receiving your valued order. Thanking you,
                        </div>
                    </td>
                    <td class="sign">
            ...
            <table class="block joined band">
                <tr><td>THANK YOU FOR THE OPPORTUNITY!</td></tr>
            </table>
</div>
