...
if ($cid == 2) {
	...
	$logo = "https://oshinservices.in//documents/images/os-logo-small.png";
	$name = "Oshin Services";
	...
	$bgcolor = "#fce6c4";
	$bgcolor1 = "#fbd190";
	$stamp="https://oshinservices.in//documents/images/os-stamp.png";
} else if ($cid == 1) {
	$invname = "Friends-Enterprises.pdf";
	$logo = "https://oshinservices.in//documents/images/fe-logo-small.png";
	...
	$bgcolor = "#f6fafd";
	$bgcolor1 = "#b3d6ec";
	$stamp="https://oshinservices.in//documents/images/fe-stamp.png";
}
...
$output .= '<table width="100%" cellpadding="0" cellspacing="0">
	...
	<td style="vertical-align: text-top"><p style="font-weight:700; font-size:12px">
...
<td width="50%" style="background-color:'.$bgcolor.'" align="center">
<img src="'. $stamp .'" >
</td>
</tr>
<tr>
